...
export function WrenchIcon({ className = 'h-5 w-5' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
      <path d="M21 6.5a4.5 4.5 0 0 1-6 4.2L7 18.7a2.1 2.1 0 1 1-3-3l8-8A4.5 4.5 0 0 1 16.2 1 4.6 4.6 0 0 0 21 6.5Z" />
    </svg>
  );
}
...
export function CommentIcon({ className = 'h-5 w-5' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
      <path d="M8 18h8l4 3V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v12Z" />
    </svg>
  );
}
